...
OBJS_TESTING = porter.o memory_management.o memory_poll.o file_transformation.o load_files.o trans.o classifier_utils.o score_document.o node_tax.o black_list_node_terms.o
