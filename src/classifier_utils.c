...
{
	//coment for perfomance test
/*	if(_classifier_document->word_poll_title->page->memory_size!=WORD_POLL_MEMORY_SIZE)
	{
		realloc_word_poll(_classifier_document->word_poll_title,WORD_POLL_MEMORY_SIZE);
	}
	if(_classifier_document->word_poll_document->page->memory_size!=WORD_POLL_MEMORY_SIZE)
	{
		realloc_word_poll(_classifier_document->word_poll_document,WORD_POLL_MEMORY_SIZE);
	}*/
	_classifier_document->node_score_buffer->current_size=0;
	_classifier_document->word_poll_document->current_size=0;
	_classifier_document->word_poll_title->current_size=0;
	_classifier_document->word_poll_summary->current_size=0;
